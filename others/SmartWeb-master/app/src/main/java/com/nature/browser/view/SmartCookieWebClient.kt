package com.nature.browser.view
...
import com.nature.browser.BuildConfig
import com.nature.browser.R
import com.nature.browser.adblock.AdBlocker
import com.nature.browser.adblock.allowlist.AllowListModel
import com.nature.browser.browser.JavaScriptChoice
import com.nature.browser.browser.SiteBlockChoice
import com.nature.browser.constant.FILE
...
import com.nature.browser.extensions.resizeAndShow
import com.nature.browser.extensions.snackbar
import com.nature.browser.js.*
...
import com.nature.browser.utils.IntentUtils
import com.nature.browser.utils.ProxyUtils
import com.nature.browser.utils.Utils
import com.nature.browser.utils.Utils.buildErrorPage
import com.nature.browser.utils.isSpecialUrl
...
class NatureBrowserClient(
    ...
    private fun installExtension(text: String){
        ...
        javascriptRepository.addJavaScriptIfNotExists(JavaScriptDatabase.JavaScriptEntry(name!!, "", version, author, inc, "", "", "", code, reqs))
                ...
                .subscribe { aBoolean: Boolean? ->
                    if (!aBoolean!!) {
                        logger.log("NatureBrowserClient", "error saving script to database")
                    }
                }
    }
        ...
        if (url.startsWith("mailto:")) {
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    println("NatureBrowserClient: cannot open downloaded file")
                }
    ...
    companion object {
        ...
        private const val TAG = "NatureBrowserClient"
