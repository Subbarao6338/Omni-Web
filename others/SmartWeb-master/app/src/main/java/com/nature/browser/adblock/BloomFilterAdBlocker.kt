package com.nature.browser.adblock

import com.nature.browser.R
import com.nature.browser.adblock.source.HostsDataSourceProvider
import com.nature.browser.adblock.source.HostsResult
import com.nature.browser.adblock.util.BloomFilter
import com.nature.browser.adblock.util.DefaultBloomFilter
import com.nature.browser.adblock.util.DelegatingBloomFilter
import com.nature.browser.adblock.util.`object`.JvmObjectStore
import com.nature.browser.adblock.util.`object`.ObjectStore
import com.nature.browser.adblock.util.hash.MurmurHashHostAdapter
import com.nature.browser.adblock.util.hash.MurmurHashStringAdapter
import com.nature.browser.database.adblock.Host
import com.nature.browser.database.adblock.HostsRepository
import com.nature.browser.database.adblock.HostsRepositoryInfo
import com.nature.browser.di.DatabaseScheduler
import com.nature.browser.di.MainScheduler
import com.nature.browser.extensions.toast
