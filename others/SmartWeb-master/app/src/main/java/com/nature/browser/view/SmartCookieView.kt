...
import com.nature.browser.DeviceCapabilities
import com.nature.browser.constant.DESKTOP_USER_AGENT
...
import com.nature.browser.isSupported
import com.nature.browser.log.Logger
import com.nature.browser.network.NetworkConnectivityModel
import com.nature.browser.preference.UserPreferences
import com.nature.browser.preference.userAgent
...
class SmartCookieView(
    ...
    private val smartCookieWebClient: NatureBrowserClient
    ...
    init {
        ...
        smartCookieWebClient = NatureBrowserClient(activity, this)
