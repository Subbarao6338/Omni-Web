package com.nature.browser.browser.activity
...
import com.nature.browser.IncognitoActivity
import com.nature.browser.R
import com.nature.browser.browser.*
import com.nature.browser.browser.bookmarks.BookmarksDrawerView
import com.nature.browser.browser.tabs.TabsDesktopView
import com.nature.browser.browser.tabs.TabsDrawerView
import com.nature.browser.controller.UIController
import com.nature.browser.database.Bookmark
import com.nature.browser.database.HistoryEntry
import com.nature.browser.database.SearchSuggestion
import com.nature.browser.database.WebPage
...
import com.nature.browser.databinding.ActivityMainBinding
import com.nature.browser.databinding.DialogAppLockBinding
import com.nature.browser.databinding.ToolbarContentBinding
import com.nature.browser.di.*
import com.nature.browser.dialog.BrowserDialog
import com.nature.browser.dialog.DialogItem
import com.nature.browser.dialog.LightningDialogBuilder
import com.nature.browser.extensions.*
import com.nature.browser.html.bookmark.BookmarkPageFactory
import com.nature.browser.html.history.HistoryPageFactory
import com.nature.browser.html.homepage.HomePageFactory
import com.nature.browser.html.incognito.IncognitoPageFactory
import com.nature.browser.icon.TabCountView
import com.nature.browser.interpolator.BezierDecelerateInterpolator
import com.nature.browser.log.Logger
import com.nature.browser.notifications.IncognitoNotification
import com.nature.browser.permissions.PermissionsManager
import com.nature.browser.popup.PopUpClass
import com.nature.browser.search.SearchEngineProvider
import com.nature.browser.search.SuggestionsAdapter
import com.nature.browser.ssl.SslState
import com.nature.browser.ssl.createSslDrawableForState
import com.nature.browser.ssl.showSslDialog
import com.nature.browser.utils.*
import com.nature.browser.view.*
import com.nature.browser.view.SearchView
import com.nature.browser.view.find.FindResults
...
abstract class BrowserActivity : ThemableBrowserActivity(), BrowserView, UIController, OnClickListener, OnKeyboardVisibilityListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prefs = getSharedPreferences("com.nature.browser", MODE_PRIVATE)
